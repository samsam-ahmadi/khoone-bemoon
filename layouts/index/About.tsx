    ...
    <AboutWrapper as="section" id="#about" name="about">
      <Container>
        ...
        <Description column justifyContent="center" alignItems="flex-end">
          ...
          <p>
            طبق آمارهای سازمان جهانی بهداشت و توصیه پزشکان عزیزمون، ماندن در
            خانه یکی از راه های مهم و کلیدی برای جلوگیری از گسترش بیماری
            کروناست. و رسوندن این پیام رو وظیفه ای مهم برای خودمون و همه
            میدونیم.
          </p>
